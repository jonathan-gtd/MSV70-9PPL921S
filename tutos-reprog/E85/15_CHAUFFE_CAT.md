...
|---|---|
| Adresse | 0x4A444 |
| Structure | Map 10×10, uint8 |
| Équation | `0.044 × raw` (°CRK retard) |
...
```
STOCK = E85 BIN (inchangé — ne pas modifier si catalyseurs présents) :
...
SI CATALYSEURS RETIRÉS → toutes cellules raw 0 (0.000 °CRK retard)
```
